...
<cfoutput>
		<div id="filterForm" style="margin:0 auto;border:1px solid ##AAA;padding:0 10px 0px 10px;float:left;background-color:##EEE;">
...
<cfoutput query="ListQuery">
	...
	<cfif ListQuery.CurrentRow MOD 2 eq 0><cfset TheBGColour = "D3E3E3"><cfelse><cfset TheBGColour = "FFFFFF"></cfif>
	...
	<cfif TheStatus eq "Ready"><cfif #EspressoMailQuery.IdEsp# gt 0><cfset TheStatusColour = "FF4500"><cfelse><cfset TheStatusColour = "CC9933"></cfif></cfif>
		...
		<td><a href="EspressoDetail.cfm?id=#ListQuery.EspID#">Details</a></td></tr>
	</cfoutput>
</table> --->
