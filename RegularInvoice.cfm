<!---Action while clicking print on invoive page for book block--->
...
<cfquery name="EspressoInvoiceQuery" datasource="SecureSource" dbtype="ODBC">
 	Select InvoiceId from vsd.vsd.EspressoInvoice
  	where InvoiceName = 'Regular#url.id#'
</cfquery>
...
<cfoutput>
	<table class="table-one" cellpadding="3" cellspacing="0" border="2" bordercolor="##00458f">
		...
		<tr><td colspan="6">
			...
			<div style="margin:2px 0 2px 3px;"><table cellspacing="0" cellpadding="2" border="1"><tr><td style="width:280px;padding-left:1px;">7510 - Espresso Book Printer Base</td><td style="width:140px;padding-left:2px;">#InvoiceLinePrints#</td></tr>
			<cfset TheBookPrinterPerPage = InvoiceLinePrints * TheBlockPageTotal>
			<tr><td style="width:280px;padding-left:1px;">7511 - Espresso Book Printer Per Page</td><td style="width:140px;padding-left:2px;">#TheBookPrinterPerPage#</td></tr></table></div>
